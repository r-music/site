...
The goal of `music21` is to have an pipe-able API of [music21 python library](http://web.mit.edu/music21/doc/index.html), created by MIT professor Michael Cuthbert. It uses  [`reticulate`](https://github.com/rstudio/reticulate) package in the backend.
